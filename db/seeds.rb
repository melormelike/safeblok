...
incident_1 = Incident.create!(user: User.first, category: "Item Stolen", authorities: "reported", status: "pending", address: "Canggu, Bali", date: Date.yesterday, description: "Someone stole my phone while I was riding my scooter. The phone was in the pocket of bike. It was dark so I didn't see how they look like.", time: "20:00")
incident_2 = Incident.create!(user: User.last, category: "Item Stolen", authorities: "reported", status: "pending", address: "Ubud, Bali", date: Date.parse('3rd April 2022'), description: "While I was in the villa, two guys jumped into the garden and stole my laptop which was in the sunbed by the pool. ", time: "8:00")
...
incident_4 = Incident.create!(user: User.last, category: "Attempt", authorities: "reported", status: "pending", address: "Ubud, Bali", date: Date.parse('3rd March 2022'), description: "in umalas", time: "8:00")
...
incident_6 = Incident.create!(user: User.last, category: "Item Stolen", authorities: "reported", status: "pending", address: "Kuta, Bali", date: Date.today, description: "2 guys ripped my necklace on a bloody driving motorbike. Risking an accident and that somebody could really get hurt for some little money?", time: "20:00")
incident_7 = Incident.create!(user: User.last, category: "Attempt", authorities: "reported", status: "pending", address: "Canggu, Bali", date: Date.today, description: "I was walking along the street with mobile phone in my hand and a boy in black hat tried rip it from my hands and run away. It was close to Indomarket", time: "21:00")
