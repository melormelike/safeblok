...
incident_6 = Incident.create!(user: User.last, category: "Item Stolen", authorities: true, address: "Kuta, Bali", date: Date.today - 3.day, description: "To the 2 guys who had ripped my necklace on a bloody driving motorbike and stole it on Sunday night in Jalan Bumbak.", time: "20:00")
incident_7 = Incident.create!(user: User.last, category: "Attempt", authorities: true, address: "Canggu, Bali", date: Date.today, description: "I was walking along the street with mobile phone in my hand and a boy in black hat tried rip it from my hands and run away. It was close to Indomarket", time: "21:00")
